  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div className="my-6">
          <button onClick={signInWithGithub} className="w-full flex items-center justify-center bg-black rounded-lg text-white text-xs text-center px-3 py-2 ">
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          ...
          <Link to="signup" className="ml-1 font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
            Sign up
          </Link>
        </p>
      </div>
